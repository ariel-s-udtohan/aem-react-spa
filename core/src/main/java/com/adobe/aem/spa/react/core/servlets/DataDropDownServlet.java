...
public class DataDropDownServlet extends SlingSafeMethodsServlet {

    private static Logger LOGGER = LoggerFactory.getLogger(DataDropDownServlet.class);
    ...
    protected void doGet(SlingHttpServletRequest request,
        ...
        try {
            ...
            if (selector.equals("pageListing")) {
            ...
            } else if (selector.equals("apiListing")) {
			    ...
			    */
                ...
                dropDownList.add(new KeyValue(selector, path));
